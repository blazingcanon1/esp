...
from espnet.nets.pytorch_backend.transformer.ff import FF
...
class Encoder(torch.nn.Module):
    ...
    def forward(self, xs, masks):
        ...
        #print(xs.shape)
        #print(self.vis_proj(xs_vis).shape)

        #xs=xs+self.vis_proj(xs_vis)
        xs=xs+self.vis_proj(torch.zeros(xs_vis.shape).cuda())
